...
<script>
  atOptions = {
    'key' : 'aeb6543c6570e1a94e3b020737bb04b0',
    'format' : 'iframe',
    'height' : 90,
    'width' : 728,
    'params' : {}
...
<script src="https://industriousslowly.com/aeb6543c6570e1a94e3b020737bb04b0/invoke.js"></script>
`;
...
<meta name="google-site-verification" content="oJdcKbrJxTCibHfhezKJKDzrBBtnmHSuTaqXkw6gq5Y" />
<title>${title}</title>
...
/* NAV */
nav{background:#1a237e;color:#fff;padding:0 1.5rem;display:flex;align-items:center;justify-content:space-between;height:60px;position:sticky;top:0;z-index:100}
...
/* HERO */
.hero{background:linear-gradient(135deg,#1a237e 0%,#0d1445 50%,#080b2e 100%);color:#fff;padding:3rem 1.5rem;text-align:center}
...
.search-bar input:focus,.search-bar select:focus{border-color:#1a237e}
...
.filter-chip.active,.filter-chip:hover{background:#1a237e;color:#fff;border-color:#1a237e}
/* LAYOUT */
...
.job-card:hover{border-color:#1a237e;transform:translateY(-2px)}
...
.btn-apply{padding:.55rem 1.3rem;background:#1a237e;color:#fff;border:none;border-radius:8px;font-weight:700;font-size:.85rem;cursor:pointer;transition:background .2s}
.btn-apply:hover{background:#0d1445}
/* JOB DETAIL */
...
.btn-apply-big{padding:.85rem 2.5rem;background:#1a237e;color:#fff;border:none;border-radius:10px;font-weight:700;font-size:1rem;cursor:pointer;transition:background .2s}
.btn-apply-big:hover{background:#0d1445}
/* PAGINATION */
...
.pagination a:hover{border-color:#1a237e;color:#1a237e}
...
/* SITEMAP NOTE */
.info-box{background:#fff;border-radius:12px;padding:1.25rem 1.5rem;border-left:4px solid #1a237e;margin-bottom:1rem;font-size:.88rem}
/* FOOTER */
...
.modal .btn-submit{width:100%;padding:.75rem;background:#1a237e;color:#fff;border:none;border-radius:8px;font-weight:700;cursor:pointer;font-size:.95rem}
.modal .btn-submit:hover{background:#0d1445}
...
${AD_TOP}
<nav>
  <a class="brand" href="/"><span>UK</span>Jobs<span>.co.uk</span></a>
  <div class="nav-links">
    <a href="/">Home</a>
...
<script>
  atOptions = {
    'key' : 'f249b6ec1e626effe1ac813e124ca110',
    'format' : 'iframe',
    'height' : 60,
    'width' : 468,
    'params' : {}
...
<script src="https://industriousslowly.com/f249b6ec1e626effe1ac813e124ca110/invoke.js"></script>
</div>
</div>
${bodyContent}
${AD_BOTTOM}
...
<div class="hero">
  ...
  <p>100,000 verified job listings — remote & on-site — across all 12 regions of the UK</p>
  ...
  <div class="stat-bar">
    ...
    <div class="stat"><strong>12</strong><span>Regions</span></div>
...
<div class="container">
  <div class="info-box">
    🇬🇧 The UK's most comprehensive job board — browse <strong>50,000 remote jobs</strong> and <strong>50,000 on-site jobs</strong> across all industries.
  </div>
   ${AD_MIDDLE}
...
<div class="hero" style="padding:1.75rem 1.5rem">
  <h1 style="font-size:1.8rem">Browse <span class="accent">100,000 Jobs</span> in the UK</h1>
...
<div class="container">
  ...
  <div style="text-align:center;margin-top:1.5rem">
    <a href="/jobs" style="color:#1a237e;font-weight:600">← Browse All 100,000 Jobs</a>
  </div>
</div>`;
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:1rem;margin-top:1rem">
    <div class="job-card">
      ...
      <div style="display:flex;flex-direction:column;gap:.5rem;margin-top:.75rem;font-size:.88rem">
        <a href="/" style="color:#1a237e">🏠 Home</a>
        <a href="/jobs" style="color:#1a237e">📋 All Jobs (100,000)</a>
        <a href="/jobs?type=remote" style="color:#1a237e">🌐 Remote Jobs (50,000)</a>
        <a href="/jobs?type=onsite" style="color:#1a237e">🏢 On-site Jobs (50,000)</a>
      </div>
    </div>
    <div class="job-card">
      <div class="card-title">XML Sitemaps</div>
      <div style="display:flex;flex-direction:column;gap:.5rem;margin-top:.75rem;font-size:.88rem">
        <a href="/sitemap.xml" style="color:#1a237e">📄 Sitemap Index</a>
        <a href="/sitemap-1.xml" style="color:#1a237e">📄 Sitemap 1 (Jobs 1–1,000)</a>
        <a href="/sitemap-2.xml" style="color:#1a237e">📄 Sitemap 2 (Jobs 1,001–2,000)</a>
    ...
    <div class="job-card">
      ...
      <div style="display:flex;flex-direction:column;gap:.5rem;margin-top:.75rem;font-size:.88rem">
        <a href="/jobs/1" style="color:#1a237e">Job #1 (First Remote Job)</a>
        <a href="/jobs/50000" style="color:#1a237e">Job #50,000 (Last Remote Job)</a>
        <a href="/jobs/50001" style="color:#1a237e">Job #50,001 (First On-site Job)</a>
        <a href="/jobs/100000" style="color:#1a237e">Job #100,000 (Last On-site Job)</a>
      </div>
    </div>
  </div>
</div>`;
...
app.listen(PORT, () => {
  console.log(`🇬🇧 UKJobs.co.uk running on port ${PORT}`);
